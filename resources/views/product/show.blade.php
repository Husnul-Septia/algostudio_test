                    ...
                    <div class="card-body">
                      ...
                      <form action="{{route('products.store')}}" method="POST">
                          @csrf
                            ...
                            <input class="form-control" id="nama_produk" name="nama_produk" required> </div>

                            <div class="form-group"> <label>Harga Beli :</label> 
                            <input class="form-control" id="harga_beli" name="harga_beli" style="text-align: right;" required></div>

                            <div class="form-group"> <label>Harga Jual :</label> 
                            <input class="form-control" id="harga_jual" name="harga_jual" style="text-align: right;" required> </div>
